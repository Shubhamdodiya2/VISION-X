// =======================
        ...
        document.addEventListener("DOMContentLoaded", () => {
            // Wait a bit for auth state to be loaded
            setTimeout(() => {
                // Get user data from localStorage (set by auth system)
        ...
        function initializeProfile(loggedInUser) {
            ...
            // Load User Data
            // ======================
            let userData = JSON.parse(localStorage.getItem(`profile_${loggedInUser.uid}`)) || {
            ...
            function saveUserData() {
                localStorage.setItem(`profile_${loggedInUser.uid}`, JSON.stringify(userData));
            }
